...
<table width="785" height="117" border="1" align="center" cellpadding="0" cellspacing="0" bordercolordark="#333333" bordercolorlight="#FFFFFF">
    <tr>
    ...
    <c:if test="${sessionScope.customer.pow.equals('2')}">
        <tr>
            <td width="786" align="center" height="27" colspan="9">
                <p align="right"> <a href="/admin/knowledge_add">发布信息...</a></td>
        </tr>
    </c:if>
    <tr>
    ...
    <c:forEach var="page" items="${page.list}">
        <tr>
            ...
            <td width="245" height="32" align="center">
                <a href="#"onClick="window.open('/knowledge_show?id=${page.id}','','width=790,height=530');">详细</a></td>
        </tr>
    </c:forEach>
    <tr>
            ...
            <table width="786" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="786" height="30" colspan="9" align="right">
                        共${page.pages}页&nbsp;&nbsp;
                        <a href="/knowledge_select?page=${page.firstPage}">第一页</a>&nbsp;&nbsp;
                        <a href="/knowledge_select?page=${page.prePage}">上一页</a>&nbsp;&nbsp;
                        <a href="/knowledge_select?page=${page.nextPage}">下一页</a>&nbsp;&nbsp;
                        <a href="/knowledge_select?page=${page.lastPage}">最后一页</a>
                    </td>
                </tr>
            </table>
        </td>
