...
<body ><center>
    <form method="POST" action="/insert" name="form1">
                    ...
                    <table height="80" border="0" cellpadding="0" cellspacing="0" background="/resources/image/2.jpg">
                        <tr>
                            <td width="787"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="100%" height="75">
                                ...
                                <embed src="/resources/image/top.swf" width="100%" height="75" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent"></embed>
                            </object></td>
                        </tr>
                    </table>
        ...
        <table width="100%" height="42" border="0" cellpadding="0" cellspacing="0" background="/resources/image/20.jpg">
            <tr>
                <td valign="bottom"><table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td><img src="/resources/image/21.jpg" width="791" height="35"></td>
                    </tr>
                </table></td>
            </tr>
        </table>
        <table width="791" border="0" cellpadding="0" cellspacing="0" background="/resources/image/22.jpg">
            <tr>
        ...
        <table width="791" height="205" border="0" cellpadding="0" cellspacing="0" background="/resources/image/23.jpg">
            <tr>
            ...
            <tr>
                ...
                <td width="54%">&nbsp; 男
                    ...
                    &nbsp; 女
                    <input type="radio" name="sex" value="woman"></td>
            </tr>
            <tr>
                <td width="46%" height="27">
        ...
        <table width="100" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td><img src="/resources/image/24.jpg" width="791" height="203"></td>
            </tr>
        </table></form>
</center>
</body>
